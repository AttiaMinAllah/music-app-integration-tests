...
void main() {
  ...
  group('Tests for Favorites Functionality', () {
    testWidgets('Verify an album is added to favorites', (tester) async {
      app.main();
     ...
     testWidgets('Verify the album is removed from favorites on the home screen', (tester) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Verify that removing an album from favorites on the top albums page is accurately reflected on the home screen', (tester) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    // Skipping this test as unfavoriting from the top albums screen is not reflected on the home screen.
  });
}